...
geography_options = ['France', 'Spain', 'Germany'] #dar la lista en vez de permitirles tipear, evita errores
geography = ''
age = 0
balance = 0.0
num_of_products = 1
...
# Declaro Función de reseteo, lleva a las variables a los valores indicados
def reset_inputs():
...
with st.form("churn_form"):
    ...
    with col2:
        is_active_member = st.selectbox("**¿Es miembro activo?**", is_active_member_options)
...
if predict_button and not error_flag:
    ...
    if class_predicted == 0:
        ...
        style_result = 'background-color: green; font-size: larger;'
    else:
